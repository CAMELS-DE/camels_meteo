...
cp /scripts/01_papermill_execute_parallel.py /output_data/scripts/01_papermill_execute_parallel.py
echo "[$(date +%T)] Saved extracted and processed HYRAS data for all CAMELS-DE stations with 01_papermill_execute_parallel.py"
...
# # Copy scripts to /camelsp/output_data/scripts/meteo/hyras
